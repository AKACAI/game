System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, director, PhysicsSystem2D, Singleton, ObjectVisualTag, GameTipManager, InputManager, MapManager, InteractManager, _dec, _class, _crd, ccclass, GameState, GameManager;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      InteractManager = _unresolved_7.InteractManager;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec(_class = class GameManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        update(deltaTime) {
          let mouseParam = (_crd && InputManager === void 0 ? (_reportPossibleCrUseOfInputManager({
            error: Error()
...
//# sourceMappingURL=fc0eb0e6c3176303a77a3f6dd00e0f97c5466ae8.js.map