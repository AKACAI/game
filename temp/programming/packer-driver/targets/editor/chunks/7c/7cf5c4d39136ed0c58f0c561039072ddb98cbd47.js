System.register(["__unresolved_0", "cc", "PriorityQueue", "Utils"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, PriorityQueue, Utils, TimerManager, _crd;

  function _reportPossibleCrUseOfPriorityQueue(extras) {
    _reporterNs.report("PriorityQueue", "PriorityQueue", _context.meta, extras);
  }
      ...
      _export("default", TimerManager = class TimerManager {
        ...
        static update() {
          ...
          for (let i = 0; i < count; i++) {
            let insertTimer = this._insertList.shift(); // TODO 可能是这个push的问题？
        ...
        static addTimer(delayTime = 0, isLoop, triggerTime, callback, param, target = this) {
        ...
        static removeTimer(id) {
          ...
          let timer = this._timerList.find(a => {
            return a._id == id;
          });
...
//# sourceMappingURL=7cf5c4d39136ed0c58f0c561039072ddb98cbd47.js.map