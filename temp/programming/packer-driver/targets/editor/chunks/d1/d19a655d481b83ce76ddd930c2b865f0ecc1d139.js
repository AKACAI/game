      ...
      _export("default", Display = class Display {
        ...
        static alignTop(node, offset, isHalfFit, isNormalWindow) {
          ...
          if (Display.isShowAll()) {
            ...
            if (isNormalWindow) {
              //求出当前ui区
              let eZone = Display.height - Display.getBottomOffset(); //设置背景缩放比例：当前ui区与设计ui区的比例，填满ui内容区
        ...
        static offSetData() {
          ...
          let deviceManufacturer = (_crd && SdkManager === void 0 ? (_reportPossibleCrUseOfSdkManager({
            error: Error()
          }), SdkManager) : SdkManager).getInstance().getDeviceManufacturer();
          let androidSysVer = (_crd && SdkManager === void 0 ? (_reportPossibleCrUseOfSdkManager({
            error: Error()
          ...
          if (sys.os == sys.OS.ANDROID) {
            if (androidSysVer > 27) {
              if ((_crd && SdkManager === void 0 ? (_reportPossibleCrUseOfSdkManager({
                ...
                let safeAreaHeight = (_crd && SdkManager === void 0 ? (_reportPossibleCrUseOfSdkManager({
                  error: Error()
        ...
        static alignLeft(node) {
          ...
          let r_scal = 1; // if (Canvas.instance.fitHeight) {
        ...
        static newLabel(fontSize, param) {
          let node = new Node(); // node.addComponent(UITransform);
        ...
        static newDigitNode(path, fontSize) {
          ...
          let font = (_crd && TextureManager === void 0 ? (_reportPossibleCrUseOfTextureManager({
            error: Error()
        ...
        static setDigitNodeProperty(node, path, string) {
          let node_label = node.getComponent(Label); // loader.loadRes("ui/digit/" + path, function (err, Font) {
        ...
        static newSprite(name) {
          let node = new Node(name); // node.addComponent(UITransform);

          node.addComponent(UIOpacity);
          let sprite = node.addComponent(Sprite); // sprite.spriteFrame = new SpriteFrame();
        ...
        static new3dSprite(name) {
          let node = new Node(name);
          let sprite = node.addComponent(Sprite); // node.addComponent(UITransform);
        ...
        static timerMoveAction(widget, endPoint, token, speed, callback, callbackData) {
          ...
          widget["moveTimeUpdate"] = function (sender) {
            ...
            let calcLinear = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        static setButtonTexture(node, normal, pressed) {
          ...
          let btn = node.getComponent(_crd && ComButton === void 0 ? (_reportPossibleCrUseOfComButton({
            error: Error()
          }), ComButton) : ComButton);

          if (btn != null) {
            if (normal != null) {
              let frame = (_crd && TextureManager === void 0 ? (_reportPossibleCrUseOfTextureManager({
                error: Error()
        ...
        static filterGrey(node, isGrey) {
          ...
          let clickComp = node.getComponent(_crd && ComButton === void 0 ? (_reportPossibleCrUseOfComButton({
            error: Error()
          }), ComButton) : ComButton);
          ...
          if (labelComp) {
            if (isGrey) {
              const mat = builtinResMgr.get('ui-sprite-gray-material');
        ...
        static loadAndSetImage(obj, path, tCallback = null, targetObj = null, isAutoReleaseImage = true, lev = 0, bundleName = (_crd && BundleName === void 0 ? (_reportPossibleCrUseOfBundleName({
          error: Error()
          ...
          let comp = node.getComponent(_crd && LoadAndSetImageComponent === void 0 ? (_reportPossibleCrUseOfLoadAndSetImageComponent({
            error: Error()
        ...
        static removeComAllClickFunc(click_widget) {
          let combutton = click_widget.getComponent(_crd && ComButton === void 0 ? (_reportPossibleCrUseOfComButton({
            error: Error()
          }), ComButton) : ComButton);
        ...
        static newImage(img_path, nodeNmae) {
          ...
          let cachedFrame = (_crd && TextureManager === void 0 ? (_reportPossibleCrUseOfTextureManager({
            error: Error()
        ...
        static newParticle(particlePath, bundleName = (_crd && BundleName === void 0 ? (_reportPossibleCrUseOfBundleName({
          error: Error()
          ...
          let partileFile = (_crd && TextureManager === void 0 ? (_reportPossibleCrUseOfTextureManager({
            error: Error()
        ...
        static instantiatePrefab(prefabPath, bundleName = (_crd && BundleName === void 0 ? (_reportPossibleCrUseOfBundleName({
          error: Error()
        }), BundleName) : BundleName).Resources) {
          let prefabAsset = (_crd && TextureManager === void 0 ? (_reportPossibleCrUseOfTextureManager({
            error: Error()
        ...
        static loadItemIconImg(node, iconPath, finishCallBack) {
          let plistPath = (_crd && PathDefine === void 0 ? (_reportPossibleCrUseOfPathDefine({
            error: Error()
          ...
          let sprFrame = (_crd && TextureManager === void 0 ? (_reportPossibleCrUseOfTextureManager({
            error: Error()
        ...
        static closeOpeningWinDow(winName) {
          ...
          let win = (_crd && WindowManager === void 0 ? (_reportPossibleCrUseOfWindowManager({
            error: Error()
        ...
        static moveOutHidWithNode(params) {
          if (params instanceof Node) {
            let moisCom = params.getComponent(_crd && MoveOutInScreenComponent === void 0 ? (_reportPossibleCrUseOfMoveOutInScreenComponent({
              error: Error()
            ...
            for (const i in params) {
              const node = params[i];
              let moisCom = node.getComponent(_crd && MoveOutInScreenComponent === void 0 ? (_reportPossibleCrUseOfMoveOutInScreenComponent({
                error: Error()
              }), MoveOutInScreenComponent) : MoveOutInScreenComponent);

              if (!moisCom) {
                moisCom = node.addComponent(_crd && MoveOutInScreenComponent === void 0 ? (_reportPossibleCrUseOfMoveOutInScreenComponent({
                  error: Error()
                }), MoveOutInScreenComponent) : MoveOutInScreenComponent);
              }
        ...
        static setModelFashion(model, fashionSetsId) {
          ...
          let itemSuit = (_crd && FashionData === void 0 ? (_reportPossibleCrUseOfFashionData({
            error: Error()
          }), FashionData) : FashionData).getInstance().getFashionSetsById(fashionSetsId);

          if (itemSuit && itemSuit.sets) {
            let tempArr = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            ...
            for (let i = 0; i < tempArr.length; i++) {
              ...
              let itemPart = (_crd && FashionData === void 0 ? (_reportPossibleCrUseOfFashionData({
                error: Error()
              }), FashionData) : FashionData).getInstance().getFashionItem(fId);

              if (itemPart) {
                let fpd = new (_crd && FashionPartData === void 0 ? (_reportPossibleCrUseOfFashionPartData({
                  error: Error()
            ...
            if (itemSuit.makeup_sets) {
              let faceCfg = (_crd && FashionData === void 0 ? (_reportPossibleCrUseOfFashionData({
                error: Error()
              }), FashionData) : FashionData).getInstance().getCosmeticsSetsDataById(itemSuit.makeup_sets);

              if (faceCfg) {
                let setsStr = faceCfg.sets;
                let setsArr = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
        ...
        static setModelFashionWithMyFace(model, fashion_id) {
          ...
          if (itemSuit && itemSuit.sets) {
            ...
            let faceData = (_crd && FashionManager === void 0 ? (_reportPossibleCrUseOfFashionManager({
              error: Error()
        ...
        */
        ...
        static addUIMeshComponent(node, layer) {
          let _layer = layer ? layer : (_crd && LayerHelper === void 0 ? (_reportPossibleCrUseOfLayerHelper({
            error: Error()
...
//# sourceMappingURL=d19a655d481b83ce76ddd930c2b865f0ecc1d139.js.map