System.register(["__unresolved_0", "cc", "MScrollItem"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_MScrollItem) {
      MScrollItem = _MScrollItem.MScrollItem;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("MScrollView", MScrollView = (_dec = ccclass('MScrollView'), _dec2 = requireComponent(Mask), _dec3 = property({
        ...
        init() {
          ...
          for (let i = 0; i < count; i++) {
            ...
            node.active = false;
            let scrollItem = node.getComponent(_crd && MScrollItem === void 0 ? (_reportPossibleCrUseOfMScrollItem({
              error: Error()
...
//# sourceMappingURL=dbed0e8cbed163832e15626ffdde22265ced54d4.js.map