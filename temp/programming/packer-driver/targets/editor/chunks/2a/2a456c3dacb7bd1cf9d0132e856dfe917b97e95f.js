System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, GameManager, GameState, UIManager, InputManager, MapManager, ObjectFactory, GameTipManager, ResManager, EventManager, EventConstants, TimerManager, _dec, _class, _crd, ccclass, property, GameApp;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TimerManager = _unresolved_11.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameApp", GameApp = (_dec = ccclass('GameApp'), _dec(_class = class GameApp extends Component {
        ...
        onInitFinish() {
          ...
          (_crd && TimerManager === void 0 ? (_reportPossibleCrUseOfTimerManager({
            error: Error()
          }), TimerManager) : TimerManager).addTimer(200, true, 200, () => {
            if (this._gameMgr.gameState == (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
              error: Error()
            }), GameState) : GameState).Ongoing) {
              this._gameMgr.pause();
            } else if (this._gameMgr.gameState == (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
              error: Error()
...
//# sourceMappingURL=2a456c3dacb7bd1cf9d0132e856dfe917b97e95f.js.map