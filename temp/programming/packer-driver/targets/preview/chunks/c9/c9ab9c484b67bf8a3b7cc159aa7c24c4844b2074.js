    ...
    execute: function () {
      ...
      _export("ObjectFactory", ObjectFactory = (_dec = ccclass('ObjectFactory'), _dec(_class = class ObjectFactory extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        createObject(type) {
          ...
          var component = newNode.addComponent(objectType2component[type]);
          component.create();
          this.objects_pre.push(component);
          return component;
        }

        getObject(type, shapeParam, pos, objectData, physicsParam, parent) {
          var object = this.objects_pre.shift();
          ...
          object.setObject(type, shapeParam, objectData, physicsParam);
...
//# sourceMappingURL=c9ab9c484b67bf8a3b7cc159aa7c24c4844b2074.js.map