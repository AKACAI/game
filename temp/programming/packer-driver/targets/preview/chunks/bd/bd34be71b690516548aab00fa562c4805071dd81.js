System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, director, PhysicsSystem2D, Singleton, GameTipManager, InputManager, MapManager, _dec, _class, _crd, ccclass, GameState, GameManager;
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec(_class = class GameManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        pause() {
          ...
          for (var i = 0; i < this._gameObjects.length; i++) {
            var object = this._gameObjects[i];
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this._gameObjects.length; i++) {
            ...
            if (!hasShowTip && object.contains(curMousePos)) {
              if (object != this._curDetectObject) {
                ...
                object.mouseEnterSpace(true, param);
              } else {
                (_crd && GameTipManager === void 0 ? (_reportPossibleCrUseOfGameTipManager({
                  error: Error()
                }), GameTipManager) : GameTipManager).getInstance().moveTip(curMousePos);
...
//# sourceMappingURL=bd34be71b690516548aab00fa562c4805071dd81.js.map