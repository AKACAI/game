  ...
  return {
    ...
    execute: function () {
      ...
      _export("ComponentHelper", ComponentHelper = class ComponentHelper extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
         ...
         * @returns 
         */
        newUINode(name, width, height, anchorX, anchorY) {
          if (name === void 0) {
            name = "UINode";
          }
          ...
          var uiTransformComp = node.addComponent(UITransform);
        ...
        newSprite(name, opacity) {
          if (name === void 0) {
            name = "Sprite";
          }

          var node = this.newUINode(name);
          node.layer = Layers.Enum.UI_2D;
        ...
        newComScrollView(param) {
          ...
          var height = param.height || 500; // ScrollView节点

          var node = this.newUINode("ScrollView", width, height);
          var scrollViewComp = node.addComponent(ScrollView);
          var comScrollViewComp = node.addComponent(_crd && ComScrollView === void 0 ? (_reportPossibleCrUseOfComScrollView({
            error: Error()
          }), ComScrollView) : ComScrollView);
          comScrollViewComp.allowUnlimitedItemSize = param.allowUnlimitedItemSize; // View节点

          var nodeView = this.newUINode("View", width, height);
          node.addChild(nodeView);
          nodeView.addComponent(Mask); // Content节点

          var content = this.newUINode("content", width, height);
          nodeView.addChild(content);
          var comScrollContentComp;
        ...
        newComButton(param) {
          ...
          var isNewComp = false;
          var comp = node.getComponent(_crd && ComButton === void 0 ? (_reportPossibleCrUseOfComButton({
            error: Error()
          }), ComButton) : ComButton);
        ...
        setButtonEnable(target, val) {
          var combutton = target.getComponent(_crd && ComButton === void 0 ? (_reportPossibleCrUseOfComButton({
            error: Error()
          }), ComButton) : ComButton);
...
//# sourceMappingURL=c73eba247c1a04a8b2c987e2cc1287afb5e982f8.js.map