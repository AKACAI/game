System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, tween, Vec3, UIPanel, UILayer, LogManager, NodeHelper, LoadType, ResManager, LevelSelectModeItem, Display, _dec, _class, _crd, ccclass, property, LevelSelectView, LevelSelectViewStatus;
      ...
      _export("LevelSelectView", LevelSelectView = (_dec = ccclass('LevelSelectView'), _dec(_class = class LevelSelectView extends (_crd && UIPanel === void 0 ? (_reportPossibleCrUseOfUIPanel({
          ...
          (_crd && ResManager === void 0 ? (_reportPossibleCrUseOfResManager({
            ...
            for (var i = 0; i < modeData.length; i++) {
              ...
              if (itemCpt) {
                ...
                itemCpt.changeMaskOpacity(true);
              }
        ...
        showOneMode(index) {
          ...
          var _loop = function _loop() {
            var item = _this.modeItems[i];

            if (i == index) {
              item.node.setSiblingIndex(_this.modeItems.length - 1);
              tween(item.node).to(_this.tweenShowAnimData.animTime, {
                position: new Vec3(-300, -40),
                scale: new Vec3(1.2, 1.2, 1)
              }).call(() => {
                _this.status = LevelSelectViewStatus.idle;
                _this.node_block_click_mask.active = false;
                item.changeMaskOpacity(true);
              }).start();
            } else {
              item.node.setSiblingIndex(_this.modeItems.length - 1 - order);
              tween(item.node).to(_this.tweenShowAnimData.animTime * 0.8, {
                position: new Vec3(-320 - 30 * order, -60),
                scale: new Vec3(1, 1, 1)
              }, {}).call(() => {
                item.changeMaskOpacity(false);
              }).start();
              order++;
            }
          };
...
//# sourceMappingURL=1285fdfebfab19d8b91c0ba61a3618072b115c9d.js.map