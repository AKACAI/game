    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec(_class = class UIManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        init() {
          ...
          var node_game_view = this.mainCanvas.getChildByName("node_ui_view");
        ...
        openPanel(panelName, finishCb, params) {
          ...
          var panelPath = (_crd && ConstStr === void 0 ? (_reportPossibleCrUseOfConstStr({
            error: Error()
          }), ConstStr) : ConstStr).PanelPath[panelName];
          var bundleName = panelPath.split("/")[0];
          var panelPrefabPath = panelPath.split("/")[1];
          (_crd && ResManager === void 0 ? (_reportPossibleCrUseOfResManager({
            ...
            (_crd && ResManager === void 0 ? (_reportPossibleCrUseOfResManager({
              ...
              var uIPanel = node.getComponent(_crd && UIPanel === void 0 ? (_reportPossibleCrUseOfUIPanel({
                error: Error()
              }), UIPanel) : UIPanel);
              ...
              if (uIPanel.layer == UILayer.normal) {
                var topPanel = this.normalPanelStack.top();
        ...
        getPanel(panelName) {
          ...
          var uIPanel = this.openingPanel.get(panelName);
          return uIPanel;
        }
        ...
        disposePanel(panel) {
          ...
          var bundleName = panelPath.split("/")[0]; //ResManager.getInstance().releaseBundle(bundleName);
        }
...
//# sourceMappingURL=126dc2794417a8f30da28d9907fc0b912763eb55.js.map