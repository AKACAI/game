  ...
  return {
    ...
    execute: function () {
      ...
      _export("ComButton", ComButton = (_dec = ccclass('ComButton'), _dec(_class = class ComButton extends Component {
        ...
        init(isDoAnim, blockClickEvent) {
          if (isDoAnim === void 0) {
            isDoAnim = true;
          }

          if (blockClickEvent === void 0) {
        ...
        _onTouchMove(event) {
          if (!!this.enabledInHierarchy || !this._isPressed) {
            return;
          } // 这部分参考了引擎的 会不会出现event为空的情况我也不知道。
        ...
        _onTouchEnd(event) {
          ...
          if (this._isPressed) {
            var dis = Vec2.distance(event.getStartLocation(), event.getLocation());
...
//# sourceMappingURL=147c30ffab5fed894d72ce8617c64362875396dc.js.map