System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, UIPanel, UILayer, UIManager, GameManager, GameState, NodeHelper, PanelName, _dec, _class, _crd, ccclass, property, GameStartMenuView;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PanelName = _unresolved_6.PanelName;
    }],
    execute: function () {
      _crd = true;
          ...
          (_crd && NodeHelper === void 0 ? (_reportPossibleCrUseOfNodeHelper({
            ...
            if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              ...
              (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
                ...
                error: Error()
              }), PanelName) : PanelName).LevelSelectView);
              this.closeBySelf();
            }
          }, this);
          (_crd && NodeHelper === void 0 ? (_reportPossibleCrUseOfNodeHelper({
...
//# sourceMappingURL=38d93ff82a3f641e13ea90d6f3db1acdc2a77daa.js.map