  ...
  return {
    ...
    execute: function () {
      ...
      _export("ResManager", ResManager = class ResManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        releaseAssetByPath(path, bundleName) {
      ...
      LoadHelper = class LoadHelper {
        ...
        static releaseAssetByPath(path, bundleName) {
          if (!this.assetsDict[bundleName]) {
            return;
          }

          var asset = this.assetsDict[bundleName][path];
          assetManager.releaseAsset(asset);
        }

        static releaseAsset(asset) {
          if (asset) {
            assetManager.releaseAsset(asset);
          }
        }
...
//# sourceMappingURL=e32e7766fa2f583ebde060bf8c563dc797ea4364.js.map