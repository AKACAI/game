System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Label, Node, Size, UIOpacity, UITransform, ButtonEventType, ComButton, Display, NodeHelper, _crd;
  ...
  function _reportPossibleCrUseOfDisplay(extras) {
    _reporterNs.report("Display", "./Display", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Button', 'Label', 'Node', 'Size', 'Sprite', 'UIOpacity', 'UITransform']);
      ...
      _export("default", NodeHelper = class NodeHelper {
        ...
        static setNodeClickEvent(click_node, click_func, target, extParams, clickAnim) {
          if (!click_node || !click_func) {
            return;
          }

          var btnCpt = click_node.getComponent(_crd && ComButton === void 0 ? (_reportPossibleCrUseOfComButton({
            error: Error()
          }), ComButton) : ComButton);
        ...
        static setNodeSizeFullScreen(node) {
          if (!node) {
            return;
          }
          ...
          var windowSize = (_crd && Display === void 0 ? (_reportPossibleCrUseOfDisplay({
            error: Error()
          }), Display) : Display).getInstance().getWindowSize();
          uiTransform.setContentSize(windowSize.x, windowSize.y);
        }
        /**设置文本节点的文本 */


        static setLabelString(node, str) {
          if (!node) {
            return;
          }

          var labelCpt = node.getComponent(Label);
...
//# sourceMappingURL=d87bcdde6d3aa75d87dc81383d59b91f04d727e4.js.map