    ...
    execute: function () {
      ...
      _export("SquareObject", SquareObject = (_dec = ccclass('SquareObject'), _dec(_class = class SquareObject extends (_crd && ObjectBase === void 0 ? (_reportPossibleCrUseOfObjectBase({
        ...
        setObject(objectType, shapeParam, objectParam, physicsParam) {
          ...
          var vertices = [new Vec2(-this._width / 2, 0), new Vec2(this._width / 2, 0), new Vec2(this._width / 2, this._height), new Vec2(-this._width / 2, this._height)];
          var mObjectParam = {
...
//# sourceMappingURL=f9dc9a280df4a75d6dbc446cb060f575b03a8a63.js.map