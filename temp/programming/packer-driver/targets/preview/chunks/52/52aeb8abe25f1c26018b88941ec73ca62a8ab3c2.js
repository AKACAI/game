System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, tween, Vec3, UIPanel, UILayer, LogManager, NodeHelper, LoadType, ResManager, LevelSelectModeItem, Display, LevelItem, MapData, _dec, _class, _crd, ccclass, property, LevelSelectView, LevelSelectViewStatus;
    ...
    execute: function () {
      ...
      _export("LevelSelectView", LevelSelectView = (_dec = ccclass('LevelSelectView'), _dec(_class = class LevelSelectView extends (_crd && UIPanel === void 0 ? (_reportPossibleCrUseOfUIPanel({
        ...
        showModeLevel(mode) {
          ...
          var showCount = Math.min(modeData.levelDatas.length, layoutData.horizonCount * layoutData.verticleCount);

          for (var _i = 0; _i < showCount; _i++) {
            var dataItem = modeData.levelDatas[_i];
            var cptItem = this.getLevelItem();
            cptItem.setData({
              level: dataItem.levelId,
              mapPath: dataItem.levelPath,
              isLock: dataItem.isLock == 1
            });
            cptItem.node.setPosition();
          }
        }
        ...
        getLevelItem() {
          ...
          var item = this.levelItemPool.pop();

          if (item) {
            return item;
          }

          var node = instantiate(this.levelItemPrefab);
          var cpt = node.getComponent(_crd && LevelItem === void 0 ? (_reportPossibleCrUseOfLevelItem({
            error: Error()
          }), LevelItem) : LevelItem);
        ...
        destroyLevelItemPool() {
          if (this.levelItemPool) {
            for (var i = 0; i < this.levelItemPool.length; i++) {
        ...
        dispose() {
          ...
          if (this.levelItems) {
            for (var _i2 = 0; _i2 < this.levelItems.length; _i2++) {
              var _this$levelItems$_i;

              (_this$levelItems$_i = this.levelItems[_i2]) == null ? void 0 : _this$levelItems$_i.dispose();
            }
          }
...
//# sourceMappingURL=52aeb8abe25f1c26018b88941ec73ca62a8ab3c2.js.map