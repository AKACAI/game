System.register(["__unresolved_0", "cc", "InputManager", "Singleton", "game/ObjectFactory", "map_manager/MapManager", "ui/game_tip/GameTipManager"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, InputManager, Singleton, _decorator, director, ObjectFactory, MapManager, GameTipManager, _dec, _class, _crd, ccclass, GameState, GameManager;
  ...
  function _reportPossibleCrUseOfGameTipManager(extras) {
    _reporterNs.report("GameTipManager", "ui/game_tip/GameTipManager", _context.meta, extras);
  }
  ...
  return {
    ...
    }, function (_map_managerMapManager) {
      MapManager = _map_managerMapManager.MapManager;
    }, function (_uiGame_tipGameTipManager) {
      GameTipManager = _uiGame_tipGameTipManager.GameTipManager;
    }],
    execute: function () {
      _crd = true;
...
//# sourceMappingURL=b5decf71b503529c6c859104eadf6c77da4b3065.js.map