  ...
  return {
    ...
    execute: function () {
      ...
      _export("ObjectBase", ObjectBase = (_dec = ccclass('ObjectBase'), _dec(_class = class ObjectBase extends Component {
        ...
        applyForce() {
          for (var from in this._curForce) {
            for (var forceItem of this._curForce[from]) {
...
//# sourceMappingURL=351075ff64218cc9dd088f6effe5b05335f44174.js.map