      ...
      _export("ObjectBase", ObjectBase = (_dec = ccclass('ObjectBase'), _dec(_class = class ObjectBase extends Component {
        ...
        pause() {
          (_crd && LogManager === void 0 ? (_reportPossibleCrUseOfLogManager({
            error: Error()
          }), LogManager) : LogManager).log("AAAAAAAAAA", this._rigidbody.linearVelocity);
        ...
        resume() {
          ...
          (_crd && LogManager === void 0 ? (_reportPossibleCrUseOfLogManager({
            error: Error()
          }), LogManager) : LogManager).log("BBBBBBBBBB", this._rigidbody.linearVelocity);
        }
...
//# sourceMappingURL=7dac564dc30985f53ca171a5a552c2dd0e4ae818.js.map