System.register(["__unresolved_0", "cc", "game_manager/GameDefinition"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Color, Vec2, Graphics, PolygonCollider2D, RigidBody2D, ERigidBody2DType, Phy_Group, _dec, _class, _crd, ccclass, property, ObjectBase;

  function _reportPossibleCrUseOfPhy_Group(extras) {
    _reporterNs.report("Phy_Group", "game_manager/GameDefinition", _context.meta, extras);
  }

  function _reportPossibleCrUseOfMouseParam(extras) {
    _reporterNs.report("MouseParam", "game_manager/GameManager", _context.meta, extras);
  }
  ...
  return {
    ...
    }, function (_game_managerGameDefinition) {
      Phy_Group = _game_managerGameDefinition.Phy_Group;
    }],
    execute: function () {
      _crd = true;
...
//# sourceMappingURL=27801bf4070ae96162c6200898effd1b76f0372d.js.map