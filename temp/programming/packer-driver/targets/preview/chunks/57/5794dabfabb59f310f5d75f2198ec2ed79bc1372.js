    ...
    execute: function () {
      ...
      _export("GameMainUIView", GameMainUIView = (_dec = ccclass('GameMainUIView'), _dec(_class = class GameMainUIView extends (_crd && UIPanel === void 0 ? (_reportPossibleCrUseOfUIPanel({
        ...
        constructor() {
          ...
          this.btn_hide = undefined;
          this.btn_pause = undefined;
        ...
        initMenuBtns() {
          for (var i = 0; i < this.node_menu_btns.children.length; i++) {}
        }
...
//# sourceMappingURL=5794dabfabb59f310f5d75f2198ec2ed79bc1372.js.map