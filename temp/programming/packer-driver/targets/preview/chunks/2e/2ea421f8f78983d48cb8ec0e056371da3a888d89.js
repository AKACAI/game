System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Color, Vec2, Graphics, PolygonCollider2D, RigidBody2D, ERigidBody2DType, Vec3, v2, Phy_Group, InteractSpace, _dec, _class, _crd, ccclass, property, ObjectBase, ForceType;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ObjectBase", ObjectBase = (_dec = ccclass('ObjectBase'), _dec(_class = class ObjectBase extends Component {
        ...
        setObject(objectType, shapeParam, objectParam, physicsParam) {
        ...
        applyForce() {
          for (var _from in this._curForce) {
            for (var forceItem of this._curForce[_from]) {
...
//# sourceMappingURL=2ea421f8f78983d48cb8ec0e056371da3a888d89.js.map