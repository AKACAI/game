System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Color, Vec2, Graphics, PolygonCollider2D, RigidBody2D, ERigidBody2DType, Vec3, Phy_Group, _dec, _class, _crd, ccclass, property, ObjectBase;
      ...
      _export("ObjectBase", ObjectBase = (_dec = ccclass('ObjectBase'), _dec(_class = class ObjectBase extends Component {
        ...
        contains(pointPos) {
          ...
          this._localVertices.forEach(vertex => {
            ...
            var x = vertex.x * Math.cos(rotation.z) + vertex.y * Math.sin(rotation.z);
            var y = -vertex.x * Math.sin(rotation.z) + vertex.y * Math.cos(rotation.z);
...
//# sourceMappingURL=774cdfcd1586118ce16eb7fa2c16ccf685ee16ab.js.map