      ...
      _export("LevelSelectView", LevelSelectView = (_dec = ccclass('LevelSelectView'), _dec(_class = class LevelSelectView extends (_crd && UIPanel === void 0 ? (_reportPossibleCrUseOfUIPanel({
        ...
        showModeLevel(mode) {
          ...
          for (var _i = 0; _i < showCount; _i++) {
            ...
            var pos = new Vec3(layoutData.startPos.x + _i % layoutData.horizonCount * layoutData.spacingX, layoutData.startPos.y + Math.floor(_i / layoutData.horizonCount) * layoutData.spacingY);
        ...
        dispose() {
          ...
          (_crd && ResManager === void 0 ? (_reportPossibleCrUseOfResManager({
            error: Error()
          }), ResManager) : ResManager).getInstance().releaseAsset(this.modeItemPrefab); //ResManager.getInstance().releaseAsset(this.levelItemPrefab);
        }
...
//# sourceMappingURL=cc3d99392ace5816e34b45f31971abe8f2f10145.js.map