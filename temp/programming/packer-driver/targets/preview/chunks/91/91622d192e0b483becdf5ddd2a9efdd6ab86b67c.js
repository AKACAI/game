System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Color, Vec2, Graphics, PolygonCollider2D, RigidBody2D, ERigidBody2DType, Vec3, v2, Phy_Group, InteractSpace, _dec, _class, _crd, ccclass, property, ObjectBase, ForceType, ObjectVisualTag;
  ...
  function _reportPossibleCrUseOfMouseParam(extras) {
    _reporterNs.report("MouseParam", "../../manager/InputManager", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("ObjectBase", ObjectBase = (_dec = ccclass('ObjectBase'), _dec(_class = class ObjectBase extends Component {
        ...
        setObject(objectId, objectType, shapeParam, objectParam, physicsParam) {
          ...
          var lineWidth = objectParam.lineWidth ? objectParam.lineWidth : this.defaultLineWidth;
          var lineColor = objectParam.lineColor ? objectParam.lineColor : this.defaultLineColor;
          var fillColor = objectParam.fillColor ? objectParam.fillColor : this.defaultFillColor;
          this.initPolygon({
            lineWidth: lineWidth,
            lineColor: lineColor,
            fillColor: fillColor,
          ...
          this._interactSpace = new (_crd && InteractSpace === void 0 ? (_reportPossibleCrUseOfInteractSpace({
            error: Error()
          }), InteractSpace) : InteractSpace)(this._localVertices);
          this.initCollider({
        ...
        initPolygon(data) {
          ...
          for (var i = 1; i < this._localVertices.length; i++) {
        ...
        addForce(force, type, from) {
          if (from === void 0) {
            from = this.defaultForceFrom;
          }
        ...
        applyForce() {
          for (var _id in this._curForce) {
            var forceItem = this._curForce[_id];
...
//# sourceMappingURL=91622d192e0b483becdf5ddd2a9efdd6ab86b67c.js.map