System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfPhysicsParam(extras) {
    _reporterNs.report("PhysicsParam", "../../modules/game/ObjectBase", _context.meta, extras);
  }
      ...
      _export("default", MapData = class MapData extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        init(finishCb) {
          ...
          (_crd && ResManager === void 0 ? (_reportPossibleCrUseOfResManager({
            ...
            (_crd && ResManager === void 0 ? (_reportPossibleCrUseOfResManager({
              error: Error()
            }), ResManager) : ResManager).getInstance().loadAsset("mapConfig", (_crd && LoadType === void 0 ? (_reportPossibleCrUseOfLoadType({
              error: Error()
              ...
              if (mapData) {
                ...
                for (var i = 0; i < mapData.length; i++) {
                  var modeItemData = mapData[i];
                  var modeID = modeItemData.modeId;
...
//# sourceMappingURL=95e9f90ff8de633015585bbb743198647f66ea4f.js.map